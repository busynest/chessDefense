...
import { _publicProfile } from './functions';
let PublicProfile = class PublicProfile extends connect(store)(PageViewElement) {
    ...
    stateChanged(state) {
        this._photoURL = state.profiles.individual_photo;
        this._website = state.profiles.individual_website;
        this._name = state.profiles.individual_name;
        this._describe = state.profiles.individual_info;
    }
