...
import { accountImage } from '../account/account_state';
...
let ContractorProfile = class ContractorProfile extends connect(store)(PageViewElement) {
    ...
    stateChanged(state) {
        this._contractorName = state.account.name;
        this._contractorPhoto = state.account.image;
        this._contractorEmail = state.account.email;
        this._contractorPhone = state.account.phone;
        this._contractorWebsite = state.profiles.individual_website;
        this._contractorInfo = state.profiles.individual_info;
        this._title = state.profiles.topic;
        this._id = state.profiles.individual_id;
        this._verify = state.profiles.currentUser;
        this._publish_Contractor = state.profiles.individual_contract;
    }
    _publishContractor() {
    ...
    _handleImage(id) {
        ...
        storageRef
            ...
            snapshot
                ...
                store.dispatch(accountImage(url));
