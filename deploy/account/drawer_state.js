...
export const drawer = (state = start, action) => {
    switch (action.type) {
        case OPEN_SIGN: return Object.assign(Object.assign({}, state), { drawer: true });
        case CLOSE_SIGN: return Object.assign(Object.assign({}, state), { drawer: false });
...
export const closeDrawer = (drawer) => { return { type: CLOSE_SIGN, drawer }; };
