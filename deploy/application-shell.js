...
let ApplicationShell = class ApplicationShell extends connect(store)(LitElement) {
    constructor() {
        super();
        this._user = false;
        this._drawer = false;
        this._offlineNote = false;
        this._offlineTxt = false;
        this._page = '';
        this._photoURL = '';
        this._id = '';
    }
    ...
    toggleDrawers() { store.dispatch(setDrawer()); }
    _anon() { firebase.auth().signInAnonymously(); }
    firstUpdated() {
...
], ApplicationShell.prototype, "_user", void 0);
__decorate([
    property({ type: Boolean })
], ApplicationShell.prototype, "_drawer", void 0);
__decorate([
    property({ type: Boolean })
], ApplicationShell.prototype, "_offlineNote", void 0);
__decorate([
    property({ type: Boolean })
], ApplicationShell.prototype, "_offlineTxt", void 0);
__decorate([
    property({ type: String })
], ApplicationShell.prototype, "_page", void 0);
__decorate([
    property({ type: String })
], ApplicationShell.prototype, "_photoURL", void 0);
__decorate([
    property({ type: String })
], ApplicationShell.prototype, "_id", void 0);
